      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-white/10 backdrop-blur-sm rounded-2xl mb-4">
            <span className="text-2xl font-bold text-white">{process.env.NEXT_PUBLIC_BUSINESS_NAME?.substring(0, 2).toUpperCase() || "CR"}</span>
          </div>
          <h1 className="text-3xl font-bold text-white">{process.env.NEXT_PUBLIC_BUSINESS_NAME || "MyCRM"}</h1>
